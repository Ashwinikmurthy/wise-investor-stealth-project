"""
Analytics API Routes for Wise Investor Platform
...
# from app.core.auth import get_current_user, verify_organization_access
# from app.models import Donation, Donor, Campaign, Program, Beneficiary
...
async def verify_organization_access(
    ...
    Args:
        organization_id: The organization ID to verify access for
        current_user: The authenticated user from JWT token
        db: Database session

    Returns:
        The verified organization_id

    Raises:
        HTTPException: If user doesn't have access to the organization
    """
    # For superadmin, allow access to any organization
...
async def get_donations(
        ...
        start_date: Optional[datetime] = Query(None, description="Start date for donation filter (YYYY-MM-DD)"),
        end_date: Optional[datetime] = Query(None, description="End date for donation filter (YYYY-MM-DD)"),
    ...
    **Query Parameters:**
    ...
    - start_date: Optional - Filter donations from this date onwards
    - end_date: Optional - Filter donations up to this date
    - donor_id: Optional - Filter by specific donor
    - campaign_id: Optional - Filter by specific campaign
    - payment_status: Optional - Filter by payment status (e.g., 'completed', 'pending')
    - min_amount: Optional - Minimum donation amount
    - max_amount: Optional - Maximum donation amount
    ...
    await verify_organization_access(organization_id, current_user, db)
...
async def get_donors(
        ...
        donor_status: Optional[str] = Query(None, description="Filter by donor status (e.g., 'active', 'lapsed')"),
        donor_type: Optional[str] = Query(None, description="Filter by donor type (e.g., 'individual', 'corporate')"),
    ...
    **Query Parameters:**
    - organization_id: Required - Organization to filter by
    - donor_status: Optional - Filter by donor status
    - donor_type: Optional - Filter by donor type
    - min_total_donated: Optional - Minimum total donated amount
...
async def get_campaigns(
    ...
    **Query Parameters:**
    ...
    - is_featured: Optional - Filter featured campaigns
    - limit: Optional - Maximum records to return (default: 100, max: 1000)
    - offset: Optional - Number of records to skip for pagination (default: 0)
    """
    # Verify user has access to this organization
...
async def get_beneficiaries(
    ...
    **Query Parameters:**
    - organization_id: Required - Organization to filter by
    - status: Optional - Filter by beneficiary status
    - gender: Optional - Filter by gender
    - income_level: Optional - Filter by income level
