...
import { 
  ...
  User, Building2, ArrowLeft, Send, Heart
} from 'lucide-react';
...
const RegisterDonor = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await fetch(`${API_BASE_URL}/api/v1/auth/register/donor`, {
        method: 'POST',
        headers: {
      ...
      <div style={styles.container}>
        <div style={styles.card}>
          ...
          <div style={styles.successCard}>
            ...
            <h2 style={styles.successTitle}>Welcome, Donor!</h2>
            <p style={styles.successMessage}>
              Your donor account for <strong>{formData.email}</strong> has been created successfully. 
              You can now log in and start engaging with the organization.
            </p>
      ...
      <div style={styles.card}>
        ...
        <div style={styles.infoBox}>
          ...
          <div style={styles.infoText}>
            Create your donor account to track your contributions and engage with the organization.
          </div>
        </div>
