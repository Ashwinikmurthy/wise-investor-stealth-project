          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              >
                ...
                <span className="text-sm font-medium">Back to Executive Dashboard</span>
              </button>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="pt-2 border-t" style={{ borderColor: COLORS.gray[200] }}>
                        <p className="text-xs" style={{ color: COLORS.gray[500] }}>
                          Lift: {lift.toFixed(2)}% • Confidence: {test.confidence_level.toFixed(0)}%
                        </p>
                      </div>
                    </div>
                  </div>
